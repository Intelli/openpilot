  ...
  def _ev9_rows(self):
    ...
    for key, title, description, maximum, step, unit in (
      ...
      ("HkgTuningAngleCustomLimitMaxSpeedKph", "EV9 Limits Speed",
       "Sets the maximum speed for higher steering limits, manual-control entry, early-turn assistance, and EV9 trajectory planning.", 40, 1, " km/h"),
