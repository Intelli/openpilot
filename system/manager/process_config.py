...
def is_ev9(started: bool, params: Params, CP: car.CarParams) -> bool:
  return started and CP.carFingerprint == "KIA_EV9"
...
procs = [
  ...
  PythonProcess("hands_free_stats", "selfdrive.hands_free_stats", is_ev9),
